...
public class KRDemo {
	...
	public static void main(String[] args) {
		...
		// krSearch("HERE IS A SIMPLE EXAMPLE", "EXAMPLE");
	...
	/**
	 * rehash 子串 rehash(sub[i+1,i+m])= ((h-a*(2^m-1))*2+b) mod q <br>
	 * a为sub[0],2^(m-1) 为a的系数,h为子串hash,b为sub[i+m]. <br>
	 * 即i+1处的子串可以由i处的子串直接结算得出（i处的子串Hash-i处子串的首字母*R^(m-1) ， <br>
